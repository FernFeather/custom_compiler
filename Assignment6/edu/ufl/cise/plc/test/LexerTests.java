...
public class LexerTests {
    ...
    void checkToken(IToken t, Kind expectedKind, int expectedLine, int expectedColumn) {
        assertEquals(expectedKind, t.getKind());
        assertEquals(new IToken.SourceLocation(expectedLine, expectedColumn),
                t.getSourceLocation());
    }
...
//Note that the quotes around "This is a string" are passed to the lexer.
    ...
    @Test
    public void testAllSymbolTokens() throws LexicalException {
        String input = """
                &
                |
                /
    ...
    void testReservedWords() throws LexicalException {
        ...
        checkToken(lexer.next(), Kind.COLOR_CONST,0,7);
        checkToken(lexer.next(), Kind.TYPE,1,0);
        checkToken(lexer.next(), Kind.TYPE,2, 0);
        checkToken(lexer.next(), Kind.TYPE,            3, 0);
        checkToken(lexer.next(), Kind.TYPE,            4, 0);
        checkToken(lexer.next(), Kind.TYPE,            5, 0);
        checkToken(lexer.next(), Kind.KW_VOID,        6, 0);
        checkToken(lexer.next(), Kind.IMAGE_OP,        7, 0);
        checkToken(lexer.next(), Kind.IMAGE_OP,        8, 0);
        checkToken(lexer.next(), Kind.COLOR_OP,        9, 0);
        checkToken(lexer.next(), Kind.COLOR_OP,        10, 0);
        checkToken(lexer.next(), Kind.COLOR_OP,        11, 0);
        checkToken(lexer.next(), Kind.COLOR_CONST,    12, 0);
        checkToken(lexer.next(), Kind.COLOR_CONST,    13, 0);
        checkToken(lexer.next(), Kind.COLOR_CONST,    14, 0);
        checkToken(lexer.next(), Kind.COLOR_CONST,    15, 0);
        checkToken(lexer.next(), Kind.COLOR_CONST,    16, 0);
        checkToken(lexer.next(), Kind.COLOR_CONST,    17, 0);
        checkToken(lexer.next(), Kind.COLOR_CONST,    18, 0);
        checkToken(lexer.next(), Kind.COLOR_CONST,    19, 0);
        checkToken(lexer.next(), Kind.COLOR_CONST,    20, 0);
        checkToken(lexer.next(), Kind.COLOR_CONST,    21, 0);
        checkToken(lexer.next(), Kind.COLOR_CONST,    22, 0);
        checkToken(lexer.next(), Kind.COLOR_CONST,    23, 0);
        checkToken(lexer.next(), Kind.COLOR_CONST,    24, 0);
        checkToken(lexer.next(), Kind.BOOLEAN_LIT,    25, 0);
        checkToken(lexer.next(), Kind.BOOLEAN_LIT,    26, 0);
        checkToken(lexer.next(), Kind.KW_IF,        27, 0);
        checkToken(lexer.next(), Kind.KW_ELSE,        28, 0);
        checkToken(lexer.next(), Kind.KW_FI,        29, 0);
        checkToken(lexer.next(), Kind.KW_WRITE,        30, 0);
        checkToken(lexer.next(), Kind.KW_CONSOLE,    31, 0);
        checkEOF(lexer.next());
    }
    ...
    @Test
    void testIntFloatError2() throws LexicalException {
        String input = """
            10.
            """;
        show(input);
    ...
    void testMany() throws LexicalException {
        ...
        checkToken(lexer.next(), Kind.FLOAT_LIT, 1, 8);
        checkToken(lexer.next(), Kind.TIMES, 1,13);
        checkToken(lexer.next(), Kind.FLOAT_LIT, 1, 15);
        ...
        checkToken(lexer.next(), Kind.TYPE, 3,0);
        checkToken(lexer.next(), Kind.IDENT, 3,8);
        checkToken(lexer.next(), Kind.ASSIGN, 3,12);
        checkToken(lexer.next(), Kind.BOOLEAN_LIT, 3,14);
